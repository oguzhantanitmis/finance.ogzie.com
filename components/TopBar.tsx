                                ...
                                >
                                    ...
                                    <div className="p-1.5">
                                        <Link
                                            ...
                                            className="flex items-center gap-3 w-full px-3 py-2 rounded-xl text-[13px] transition-colors cursor-pointer hover:bg-[var(--bg-hover)]"
                                    ...
                                    <div className="p-1.5" style={{ borderTop: '1px solid var(--border-default)' }}>
                                        <button
                                            ...
                                            className="flex items-center gap-3 w-full px-3 py-2 rounded-xl text-[13px] transition-colors cursor-pointer hover:bg-[var(--accent-danger-bg)]"
